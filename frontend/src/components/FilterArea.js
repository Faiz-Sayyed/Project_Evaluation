            ...
            <div className='w-full px-5 py-5 bg-gray-300 drop-shadow-lg rounded-lg'>
                <div className='sm:flex justify-between w-full md:w-3/4 lg:w-1/2'>
                    ...
                    <div className='flex items-center mt-3 sm:mt-0'>
                        ...
                        <label htmlFor="none" className='ml-2 text-xl'>All</label>
                    </div>

                    <div className='flex items-center'>
                        <input type="radio" id="marked" name="filter" onChange={(e) => setFilter(1)} />
                        <label htmlFor="marked" className='ml-2 text-xl'>Marked</label>
                    </div>

                    <div className='flex items-center'>
                        <input type="radio" id="notMarked" name="filter" onChange={(e) => setFilter(0)} />
                        <label htmlFor="notMarked" className='ml-2 text-xl'>Not Marked</label>
                    </div>
                </div>
            </div>
        </form>
